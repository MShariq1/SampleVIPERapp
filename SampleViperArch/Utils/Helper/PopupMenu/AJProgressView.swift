...
class AJProgressView: UIView {
    ...
    private var widthProgressView : CGFloat {
        ...
        if DeviceType.iPhone4 || DeviceType.iPhone5_5s{
            ...
            width = ScreenSize.Min_Length*0.1
    ...
    public var imgLogo: UIImage = UIImage() /// UIImage(named:"blue-logo-icon")!
   
    // Pass your color here which will be used as layer color
    public var firstColor: UIColor? = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
