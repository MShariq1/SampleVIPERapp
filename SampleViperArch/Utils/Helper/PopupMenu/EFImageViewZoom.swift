...
public class EFImageViewZoom: UIScrollView {
    ...
    public override func awakeFromNib() {
        ...
        self.setupTap()
        self.delegate = self
//        NotificationCenter.default.addObserver(self, selector: #selector(screenOrientationChanged), name: UIDevice.Noti.Name.UIDeviceOrientationDidChange, object: nil)
    }
